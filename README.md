...
| Provider | Texto | Imagem |
|---|---|---|
| **OpenAI** | GPT-4.1, GPT-4o, o3, o4-mini | gpt-image-1 |
| **Anthropic** | Claude 3.5 Sonnet, Claude 3 Opus | — |
| **Google Gemini** | Gemini 2.0, Gemini 1.5 | Gemini Image Generation |

> Basta configurar sua chave de API em **Configurações → LLM** e todos os modelos ficam disponíveis.
...
- Chave de API de ao menos um provedor de IA (OpenAI, Anthropic ou Google Gemini)
